        ...
        <aside class="main-sidebar">
            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    @role('admin')
                        <li class="header">博客内容管理</li>
                        <li><a href="{{ route('post.index') }}"><i class="fa fa-fw fa-file"></i><span>文章管理</span></a></li>
                        <li><a href="{{ route('tags.index') }}"><i class="fa fa-fw fa-tags"></i><span>标签管理</span></a></li>
                        <li class="header">团队管理</li>
                        <li><a href="{{ route('users.index') }}"><i class="fa fa-fw fa-user"></i><span>成员管理</span></a></li>
                        <li><a href="{{ route('group.index') }}"><i class="fa fa-fw fa-group"></i><span>团队设置</span></a></li>
                    @else
